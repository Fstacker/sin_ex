...
module SpecHelper
  ...
  NUMEROLOGY = {
    ...
    "2" => { birthdate: "12161999", message: "Two is the mediator and peace-lover.  The number two indicates the desire for harmony.  It is a gentle, considerate, and sensitive vibration.  Ruled by the Moon." },
    "3" => { birthdate: "12171999", message: "Three is a sociable, friendly, and outgoing vibration.  Kind, positive, and optimistic, Three's enjoy life and have a good sense of humor." },
    "4" => { birthdate: "12181999", message: "This is the worker.  Practical, with a love for detail, Fours are trustworthy, hard-working, and helpful.  Ruled by Youranus." },
