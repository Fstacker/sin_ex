...
def get_message(birth_path_num)
	...
	when 3
		message = "Your numerology number is #{birth_path_num}. \nThree is a sociable, friendly, and outgoing vibration.  Kind, positive, and optimistic, Three's enjoy life and have a good sense of humor."
	when 4
		message = "Your numerology number is #{birth_path_num}. \nThis is the worker.  Practical, with a love for detail, Fours are trustworthy, hard-working, and helpful.  Ruled by Youranus."
	when 5
